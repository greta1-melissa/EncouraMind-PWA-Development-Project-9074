  ...
  return (
    ...
    >
      ...
      <div className={`p-8 rounded-2xl text-center ${
        isDark 
          ? 'bg-gradient-to-br from-indigo-900/50 to-purple-900/50 border border-gray-700' 
        ...
        <p className="text-xl text-gray-600 dark:text-gray-400 mb-6 max-w-3xl mx-auto">
          Take our evidence-based wellness assessment to gain insights into your mental health, physical wellbeing, social connections, stress management, and lifestyle habits.
        </p>
        <motion.button
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {[
          ...
          },
          {
            ...
            description: 'Get personalized insights and professional-grade analysis of your results',
            icon: FiFileText,
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-4">
          {[
            ...
            },
            {
              ...
              icon: '💪',
              description: 'Exercise, sleep, and nutrition habits'
            },
            {
            ...
            },
            {
              ...
              icon: '🌅',
              description: 'Coping strategies and resilience'
            },
            {
              ...
              if (assessment.scores && Object.keys(assessment.scores).length > 0) {
                ...
                if (validScores.length > 0) {
                  overallScore = Math.round(
                    validScores.reduce((sum, score) => sum + score.percentage, 0) / 
                    validScores.length
                  );
                }
              }
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {(() => {
              ...
              const latestScore = previousAssessments[0]?.scores ? 
                Math.round(Object.values(previousAssessments[0].scores).reduce((sum, score) => sum + score.percentage, 0) / Object.values(previousAssessments[0].scores).length) : 0;
              
              const avgScore = previousAssessments.length > 0 ? 
                Math.round(
              ...
              const trend = previousAssessments.length >= 2 ? 
                latestScore - Math.round(Object.values(previousAssessments[1].scores || {}).reduce((sum, score) => sum + (score.percentage || 0), 0) / Math.max(Object.values(previousAssessments[1].scores || {}).length, 1)) : 0;
      ...
      >
        <p className="text-gray-600 dark:text-gray-400 mb-4">
          Ready to gain insights into your wellness? The assessment takes about 5-10 minutes to complete.
        </p>
        <motion.button
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
