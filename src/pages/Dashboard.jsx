...
const {FiHeart,FiTrendingUp,FiTarget,FiBookOpen,FiClipboard,FiActivity,FiArrowRight}=FiIcons;
...
description: 'Comprehensive evaluation of your mental wellness',
icon: FiClipboard,
...
{
title: 'Set Goals',
description: 'Create meaningful wellness objectives',
icon: FiTarget,
link: '/goals',
...
<div className={`p-6 rounded-xl ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white border border-gray-200'} shadow-lg hover:shadow-xl transition-all duration-300 relative overflow-hidden ${action.highlight ? 'ring-2 ring-purple-500 ring-opacity-50' : ''}`}>
{action.highlight && (
...
className={`p-6 rounded-xl ${isDark ? 'bg-gray-800 border border-gray-700' : 'bg-white'} shadow-lg relative overflow-hidden`} 
> 
