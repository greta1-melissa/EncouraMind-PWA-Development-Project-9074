        ...
        <Link to="/resources" className="block">
          ...
          >
            ...
            <div className="absolute top-6 right-6">
              <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300">
            ...
            <div className="flex items-start space-x-8">
              {/* Icon */}
              <div className="p-5 rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-600 shadow-lg group-hover:scale-110 transition-transform duration-300">
                <SafeIcon icon={FiLeaf} className="w-12 h-12 text-white" />
              </div>

              {/* Content */}
              <div className="flex-1">
                <h3 className="text-3xl font-bold mb-4 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                ...
                {/* Action Button */}
                <div className="flex items-center text-xl font-semibold text-emerald-600 dark:text-emerald-400 group-hover:text-emerald-700 dark:group-hover:text-emerald-300 transition-colors">
            ...
            >
              <Link to={action.link} className="block">
                <div className={`p-6 rounded-2xl ${
                  ...
                  action.highlight ? 'ring-2 ring-purple-500 ring-opacity-50' : ''
                }`}
                style={{
                  backgroundImage: isDark 
